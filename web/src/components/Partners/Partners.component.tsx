  ...
  return (
    ...
    >
      ...
      <div className='flex gap-32 mt-16 w-full justify-center items-center'>
        <Link href="https://portal.cmp.ifsp.edu.br/" target='_blank'  className='ml-20'>
          <Image src={ifsp} alt='' width={120} className='md:w-[10rem]' />
        </Link>
        <Link href="https://minorplanetcenter.net/" target='_blank'>
          <Image src={mpc} alt='' width={190} className=' md:w-[16rem] md:mb-11' />
        </Link>
        <Link href="https://www.nasa.gov/" target='_blank'>
          <Image src={nasa} alt='' width={190} className='md:w-[16rem] md:mb-11' />
        </Link>
      </div>
    </div>
  );
